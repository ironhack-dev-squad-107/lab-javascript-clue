...
var drOrchid = {first_name: "Doctor",
                 last_name: "Orchid",
                     color: "white",
...
var profPlum = {first_name: "Victor",
                 last_name: "Plum",
                     color: "purple",
...
var missScarlet = {first_name: "Kasandra",
                    last_name: "Scarlet",
                        color:   "red",
...
var mrsPeacock = {first_name: "Eleanor",
                   last_name: "Peacock",
                       color: "blue",
...
function reveal_mistery(array) {
  console.log(array[0].first_name + " " + array[0].last_name + " killed Mr.Boddy using the " + array[1].name + " in the " + array[2].name + "!!!!");
}
